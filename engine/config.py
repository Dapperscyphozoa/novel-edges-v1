...
STRATEGY_PARAMS = {
    ...
    # mev-revert
    "mev_min_impact_pct": 0.008,
    "mev_strong_impact_pct": 0.018,
    "mev_sl_atr_mult": 0.8,
    "mev_tp_atr_mult": 2.0,
    "mev_max_hold_bars": 4,
    # listings-decay
    ...
    "listings_min_funding_hr": 0.00025,
    "listings_strong_funding_hr": 0.00045,
    "listings_min_wick_pct": 0.02,
    "listings_strong_wick_pct": 0.035,
    "listings_sl_atr_mult": 1.5,
    "listings_tp_atr_mult": 3.5,
    "listings_max_hold_bars": 8,
    # lst-discount
    "lst_discount_threshold": -0.0025,
    "lst_strong_discount": -0.005,
    "lst_rich_threshold": 0.015,
    "lst_sl_atr_mult": 2.0,
    "lst_tp_atr_mult": 4.5,
    "lst_max_hold_bars": 96,
    # oracle-lag
    "oracle_basis_threshold_bps": 10,
    "oracle_strong_threshold_bps": 18,
